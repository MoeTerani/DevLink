        ...
        switch (_b.label) {
          case 0:
            ...
            (_a = req.body),
              ...
              (skills = _a.skills),
              (status = _a.status),
              (githubusername = _a.githubusername),
              (youtube = _a.youtube),
              (twitter = _a.twitter),
              (instagram = _a.instagram),
              (linkedin = _a.linkedin),
            ...
            profileFields = {
              ...
              skills: Array.isArray(skills)
                ? skills
                : skills.split(',').map(function (skill) {
                    return ' ' + skill.trim();
                  }),
              status: status,
...
// @access  Private
router['delete']('/experience/:id', Auth, function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          profile = _a.sent();
          id_1 = req.params.id;
          profile.experience = profile.experience.filter(function (experience) {
            return experience.id !== id_1;
          });
          return [4 /*yield*/, profile.save()];
        case 2:
          _a.sent();
...
// @access  Private
router['delete']('/education/:id', Auth, function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
